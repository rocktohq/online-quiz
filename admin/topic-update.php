...
if(isset($_SESSION['admin'])) {
    ...
    if(isset($_GET['eid'])) {
        ...
        if(isset($_POST['update'])) {
            ...
            if(empty($department)) {
                $department = topicDepartment($eid);
            ...
            if(empty($message)) {
                ...
                if($result) {
                    $_SESSION['notification'] = 'Topic Updated Successfully!';
                    $_SESSION['type'] = "success";
                    header("Location: topics.php");
                } else {
                    $_SESSION['notification'] = 'Error Updating Topic!';
                        ...
                        <nav class="navbar-light fw-bold">
                            <ul class="navbar-nav">
                               ...
                               <li>
                                ...
                                <!-- Topics -->
                                <li>
                                    <a class="nav-link active px-3" href="topics.php">
                                        <span class="me-2"><i class="bi bi-journal-plus"></i></span>
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="name" id="name" value="<?php echo topicname($eid); ?>" required>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" name="department" id="department">
                                    ...
                                    if($result->num_rows > 0) { 
                                        ...
                                        <option value="<?php echo strtolower($row['name']); ?>"><?php echo strtoupper($row['name']); ?></option>
