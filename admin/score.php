    ...
    <main class="mt-md-5">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="offcanvas-body p-0">
                        <nav class="navbar-light fw-bold">
                            <ul class="navbar-nav">
                                ...
                                <li>
                                    <a class="nav-link active px-3" href="score.php">
                ...
                <!-- Main Contents -->
                <div class="col-md-9">
                    <h2 class="fw-bold">Score Board</h2>
                    <div class="row">
                    <?php 
                   ...
                   // Now Fetch Data form Admin
                    $sql = "SELECT * FROM `score` ORDER BY `created_at` DESC";
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-bordered cursor-pointer col-sm-12">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        <td><?php echo $i; $i++;?></td>
                                        <td><?php echo username($row['user']); ?></td>
