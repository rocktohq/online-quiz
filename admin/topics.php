                ...
                <div class="col-md-9">
                    ...
                    ?>
                        <div class="mb-3 request">
                            <a class="btn btn-success" href="topic-add.php">Add Topic</a>
                        </div>
                    <?php 
